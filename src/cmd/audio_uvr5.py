...
from src.service.audio import AudioService, AudioUVR5Params
...
def main():
    ...
    try:
        ...
        params = AudioUVR5Params(**config)
        service = AudioService(source_dir=params.source_dir, output_dir=params.output_dir)
        output = service.uvr5(model_name=params.model_name, audio_format=params.audio_format)
