...
if OPERATING_SYSTEM == 'Windows':
    ...
    import src.audiokit.uvr5.lib_v5.vr_network.pyrb as pyrb
...
def align_audio(file1,
    ...
    for s in wav2_aligned_sources:
        ...
        if align_window:
            wav_sub = time_correction(wav1, wav2_aligned, seconds_length, align_window=align_window, db_analysis=db_analysis, progress_bar=progress_bar, unique_sources=unique_sources,
