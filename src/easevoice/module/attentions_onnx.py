...
class MultiHeadAttention(nn.Module):
    ...
    def _get_relative_embeddings(self, relative_embeddings, length):
        ...
        pad_l = torch.zeros((1), dtype=torch.int64) + length - (self.window_size + 1)  # pyright: ignore
        pad_s = torch.zeros((1), dtype=torch.int64) + (self.window_size + 1) - length  # pyright: ignore
